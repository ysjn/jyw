...
$site_top = "http://www.idd.tamabi.ac.jp/m47069/jy/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "jun.yoyoyoshida@gmail.com";
...
$Referer_check_domain = "idd.tamabi.ac.jp";
...
$subject = "jyポートフォリオ・ホームページのお問い合わせ";
...
<h4>There's some kind of ERROR. Please check your inputs by clicking "Back" button below.</h4>
...
<input type="submit" value="　送信する / Send　">
<input type="button" value="前画面に戻る / Back" onClick="history.back()"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
</div>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4><h4>There's some kind of ERROR. Please check your inputs by clicking "Back" button below.</h4>
<div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る / Back " onClick="history.back()"></div>
<?php 
