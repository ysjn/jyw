...
export const WORKS = [
  {
    ...
    gallery: [
      { src: '/works/tabs/1.png', thSrc: '/works/tabs/th_1.png', alt: '' },
      { src: '/works/tabs/2.gif', thSrc: '/works/tabs/th_2.png', alt: '' },
      { src: '/works/tabs/3.gif', thSrc: '/works/tabs/th_3.png', alt: '' },
      { src: '/works/tabs/4.gif', thSrc: '/works/tabs/th_4.png', alt: '' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: '/works/boldit/1.png', thSrc: '/works/boldit/th_1.png', alt: '' },
      { src: '/works/boldit/2.png', thSrc: '/works/boldit/th_2.png', alt: '' },
      { src: '/works/boldit/3.png', thSrc: '/works/boldit/th_3.png', alt: '' },
      { src: '/works/boldit/4.png', thSrc: '/works/boldit/th_4.png', alt: '' },
    ],
  ...
  },
  {
    ...
    siteUrl: '',
    gallery: [
      { src: '/works/atsum/1.png', thSrc: '/works/atsum/th_1.png', alt: '' },
      { src: '/works/atsum/2.png', thSrc: '/works/atsum/th_2.png', alt: '' },
      { src: '/works/atsum/3.png', thSrc: '/works/atsum/th_3.png', alt: '' },
      { src: '/works/atsum/4.png', thSrc: '/works/atsum/th_4.png', alt: '' },
    ],
  ...
  },
  {
    ...
    siteUrl: '',
    gallery: [
      { src: '/works/fbm/1.png', thSrc: '/works/fbm/th_1.png', alt: '' },
      { src: '/works/fbm/2.png', thSrc: '/works/fbm/th_2.png', alt: '' },
      { src: '/works/fbm/3.png', thSrc: '/works/fbm/th_3.png', alt: '' },
      { src: '/works/fbm/4.png', thSrc: '/works/fbm/th_4.png', alt: '' },
    ],
    tags: ['Web', 'Individual work', 'Undergraduate', 'HTML', 'CSS', 'JavaScript'],
  },
  {
    ...
    siteUrl: '',
    gallery: [
      { src: '/works/2032/1.png', thSrc: '/works/2032/th_1.png', alt: '' },
      { src: '/works/2032/2.png', thSrc: '/works/2032/th_2.png', alt: '' },
      { src: '/works/2032/3.png', thSrc: '/works/2032/th_3.png', alt: '' },
      { src: '/works/2032/4.png', thSrc: '/works/2032/th_4.png', alt: '' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: '/works/blks/1.png', thSrc: '/works/blks/th_1.png', alt: '' },
      { src: '/works/blks/2.png', thSrc: '/works/blks/th_2.png', alt: '' },
  ...
  },
  {
    ...
    siteUrl: '',
    gallery: [
      { src: '/works/bfp/1.jpg', thSrc: '/works/bfp/th_1.png', alt: '' },
      { src: '/works/bfp/2.jpg', thSrc: '/works/bfp/th_2.png', alt: '' },
      { src: '/works/bfp/3.jpg', thSrc: '/works/bfp/th_3.png', alt: '' },
      { src: '/works/bfp/4.jpg', thSrc: '/works/bfp/th_4.png', alt: '' },
    ],
